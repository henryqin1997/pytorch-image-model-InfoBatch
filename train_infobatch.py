...
from timm.data import create_dataset, create_loader_infobatch, resolve_data_config, Mixup, FastCollateMixup, AugMixDataset
...
def main():
    ...
    dataset_train = InfoBatch(dataset_train,ratio = 0.5, num_epochs = args.epoch, delta=0.85)
    ...
    loader_train = create_loader_infobatch(
        dataset_train,
    ...
    if args.jsd_loss:
        ...
        print("Using JsdCrossEntropy which is not adapted for InfoBatch")
...
#             train_loss_fn = SoftTargetCrossEntropy()
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            train_metrics = train_one_epoch_infobatch(
                epoch,
                model,
                loader_train,
                optimizer,
