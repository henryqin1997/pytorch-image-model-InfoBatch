...
def main():
    ...
    if args.infobatch_version=='v2':
        ...
        dataset_train = infobatch_quantile.InfoBatch(dataset_train,ratio =[0.25,0.5], batch_size = args.batch_size, num_epoch = args.epochs, delta=0.825, quantiles=args.infobatch_quantile)
    else:
